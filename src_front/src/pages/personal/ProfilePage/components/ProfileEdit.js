...
const URL_BASE_IMG =
  "https://chess-center.ru/wp-content/uploads/2022/09/2_4yls8wlami9frintdrgsya.jpeg";
    ...
    <div className="profile_show_test">
      <div className="container">
        <div className="profile_show_test__content">
          ...
          <div className="profile_show_test_img">
            ...
            <div>
              ...
              <label htmlFor="raised-button-file">
                <Button component="span">Выберите файл</Button>
              </label>
            </div>
          </div>

          <span className="profile_show_test_info">
          ...
          <input
            className="profile_show_test_input"
        ...
        <Stack direction="row" spacing={2}>
          <button
            className="profile_show_test_btn2"
            onClick={() => {
              handleSubmit();
