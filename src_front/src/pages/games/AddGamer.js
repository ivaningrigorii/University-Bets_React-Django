...
const AddGamer = ({ setChangeGamers, gamers, id_game }) => {
  ...
  return (
    <div>
      ...
      >
        <DialogTitle id="alert-dialog-title">{"Записать команду"}</DialogTitle>
        <DialogContent>
          ...
          <Stack direction="column" justifyContent="center">
            <FormControl fullWidth>
              ...
              >
                {ownTeams &&
                  ownTeams.map((t, index) => {
                    return <MenuItem value={index + 1}>{t.name}</MenuItem>;
                  })}
              </Select>
            </FormControl>
          </Stack>
