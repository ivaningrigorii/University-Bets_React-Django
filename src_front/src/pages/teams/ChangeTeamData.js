...
const ChangeTeamData = ({ setChange, team, }) => {
    ...
    const handleCreateTeam = async (data) => {
        ...
        return axios.patch(("api/team/" + team.id + "/"), data, {
            headers: {
    ...
    return (
        <div>
            <Button size="small" onClick={handleClickOpen}>Изменить</Button>
            <Dialog
                open={open}
                onClose={handleClose}
            ...
            >
                ...
                <DialogContent>
                    ...
                    <Stack direction="column" justifyContent="center">
                        ...
                        <TextField label="Название команды"
                            defaultValue={name}
                            onChange={(event) => setName(event.target.value)}
                            sx={{ mt: "2vh", }}
                        />
                        <TextField label="Описание команды"
